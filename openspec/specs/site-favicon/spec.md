# site-favicon Specification

## Purpose
Defines the branded favicon and icon set served for A Wish For, replacing the create-t3-app placeholder favicon and manifest, and how the icon set is wired into root metadata.
