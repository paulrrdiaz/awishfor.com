# wishlist-cover-images Specification

## Purpose

Defines first-class wishlist cover-image records, their persisted orientation classification, order, and exposure to consumers.
