# not-found-pages Specification

## Purpose
Defines the branded, Spanish-language 404 experiences for public wishlist, marketing, and dashboard routes, the shared escaped-gift illustration with its looping motion and legible resting state, and the 404 HTTP status contract.
