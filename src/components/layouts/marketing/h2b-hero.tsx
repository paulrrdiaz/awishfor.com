...
export function H2bHero() {
	return (
		<section
			...
			data-h2b-hero
			data-hero-rotator
			style={HERO_SCRIM_VALUES[HERO_OCCASIONS[0].scrim]}
		>
			<div className="absolute inset-x-0 top-0 h-full overflow-hidden">
				{HERO_OCCASIONS.map((occasion, index) => (
					...
					>
						<Image
							alt=""
							className="object-cover brightness-[1.2] contrast-[.95] saturate-[1.06] lg:hidden"
							fetchPriority={index === 0 ? "high" : "low"}
							fill
							loading={index === 0 ? "eager" : "lazy"}
							priority={index === 0}
							sizes="100vw"
							src={occasion.photo.mobile}
						/>
						<Image
							alt=""
							className="hidden object-cover brightness-[1.2] contrast-[.95] saturate-[1.06] lg:block"
							fetchPriority={index === 0 ? "high" : "low"}
							fill
							loading={index === 0 ? "eager" : "lazy"}
							priority={index === 0}
							sizes="(min-width: 1240px) 1240px, 100vw"
							src={occasion.photo.desktop}
						/>
					</div>
				))}
				<div
					aria-hidden
					className="absolute inset-0 bg-[linear-gradient(96deg,rgb(8_26_15_/_var(--hero-scrim-horizontal-start))_0%,rgb(8_26_15_/_var(--hero-scrim-horizontal-middle))_50%,rgb(8_26_15_/_var(--hero-scrim-horizontal-end))_80%)]"
				/>
				<div
					aria-hidden
					className="absolute inset-0 bg-[linear-gradient(180deg,rgb(8_26_15_/_var(--hero-scrim-vertical-top))_0%,rgb(8_26_15_/_0%)_40%,rgb(8_26_15_/_var(--hero-scrim-vertical-bottom))_100%)]"
				/>
				<div
					aria-hidden
					className="absolute inset-x-0 top-0 h-[112px] bg-[linear-gradient(180deg,rgb(8_26_15_/_var(--hero-scrim-header)),rgb(8_26_15_/_0%))]"
				/>
			</div>

			<div className="absolute inset-x-0 bottom-0 mx-auto h-full max-w-[1240px]">
