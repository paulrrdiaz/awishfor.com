...
export function H2bHero() {
	...
	return (
		...
		>
			...
			<div className="absolute inset-x-0 bottom-0 z-30 h-full">
				<MarketingContainer className="relative h-full">
					<div className="absolute right-[22px] bottom-16 left-[22px] max-w-[520px] text-white lg:right-11 lg:left-11 lg:max-w-[700px]">
						...
						<p className="mt-4 max-w-[480px] text-[15px] text-white/[.82] leading-[1.6] lg:text-[16px] lg:leading-[1.62]">
							...
							<span className="hidden lg:inline">
								Agrega regalos de cualquier tienda, comparte por enlace,
								WhatsApp o QR, y deja que tus invitados marquen lo que compran.
							</span>
						</p>
