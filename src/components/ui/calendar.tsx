	...
	return (
		<DayPicker
			...
			classNames={{
				...
				dropdown_root: cn(
					"relative rounded-lg border border-input shadow-xs has-focus:border-ring has-focus:ring-3 has-focus:ring-ring/50",
